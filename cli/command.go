...
type Command struct {
	...
	// helpCommand is command with usage 'help'.
	// If it's not defined by user, default is help command is used.
	helpCommand *Command
	...
	// SuggestionsMaximumDistance defines minimum levenshtein distance to display suggestions.
	// Must be > 0.
...
func (c *Command) SetGlobalNormalizationFunc(n func(f *pflag.FlagSet, name string) pflag.NormalizedName) {
...
func (c *Command) HelpFunc() func(*Command, []string) {
	...
	return func(c *Command, a []string) {
		...
		// See https://github.com/tprasadtp/pkg/cli/issues/1002
...
// Otherwise, commands that look like
// openshift admin policy add-role-to-user admin my-user,
// lose the admin argument (arg[4]).
...
func (c *Command) ExecuteC() (cmd *Command, err error) {
	...
	// pre exec hook (deals with mousetrap on windows)
	preExecHook(c)
...
// Concrete example: https://github.com/tprasadtp/pkg/cli/issues/393#issuecomment-282741924.

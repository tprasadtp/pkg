...
func TestRequiredFlags(t *testing.T) {
	c := &Command{Use: "c", Run: emptyRun}
	c.Flags().String("foo1", "", "")
	AssertErrNil(t, c.MarkFlagRequired("foo1"))
	c.Flags().String("foo2", "", "")
	AssertErrNil(t, c.MarkFlagRequired("foo2"))
	c.Flags().String("bar", "", "")
...
func TestPersistentRequiredFlags(t *testing.T) {
	...
	AssertErrNil(t, parent.MarkPersistentFlagRequired("foo1"))
	parent.PersistentFlags().String("foo2", "", "")
	AssertErrNil(t, parent.MarkPersistentFlagRequired("foo2"))
	parent.Flags().String("foo3", "", "")

	child := &Command{Use: "child", Run: emptyRun}
	child.Flags().String("bar1", "", "")
	AssertErrNil(t, child.MarkFlagRequired("bar1"))
	child.Flags().String("bar2", "", "")
	AssertErrNil(t, child.MarkFlagRequired("bar2"))
...
func TestPersistentRequiredFlagsWithDisableFlagParsing(t *testing.T) {
	...
	AssertErrNil(t, parent.MarkPersistentFlagRequired("foo"))
...
// Related to https://github.com/tprasadtp/pkg/cli/issues/302.
...
func TestPersistentHooks(t *testing.T) {
	...
	for _, v := range []struct {
		...
		// If the behavior changes (https://github.com/tprasadtp/pkg/cli/issues/252)
...
// Related to https://github.com/tprasadtp/pkg/cli/issues/521.
...
// Related to https://github.com/tprasadtp/spf13/issues/404.
...
// Related to https://github.com/tprasadtp/pkg/cli/issues/443.
...
// if cli.Execute() prints a message, if a deprecated flag is used.
// Related to https://github.com/tprasadtp/pkg/cli/issues/463.
func TestUseDeprecatedFlags(t *testing.T) {
	c := &Command{Use: "c", Run: emptyRun}
	c.Flags().BoolP("deprecated", "d", false, "deprecated flag")
	AssertErrNil(t, c.Flags().MarkDeprecated("deprecated", "This flag is deprecated"))
...
// Related to https://github.com/tprasadtp/cobra/pull/422#discussion_r143918343.

...
[![godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/github.com/tprasadtp/pkg/zerolog) [![license](http://img.shields.io/badge/license-MIT-red.svg?style=flat)](https://raw.githubusercontent.com/rs/zerolog/master/LICENSE) [![Build Status](https://travis-ci.org/rs/zerolog.svg?branch=master)](https://travis-ci.org/rs/zerolog) [![Coverage](http://gocover.io/_badge/github.com/tprasadtp/pkg/zerolog)](http://gocover.io/github.com/tprasadtp/pkg/zerolog)
...
Find out [who uses zerolog](https://github.com/tprasadtp/pkg/zerolog/wiki/Who-uses-zerolog) and add your company / project to the list.
...
```bash
go get -u github.com/tprasadtp/pkg/zerolog/log
```
...
For simple logging, import the global logger package **github.com/tprasadtp/pkg/zerolog/log**

```go
package main

import (
    "github.com/tprasadtp/pkg/zerolog"
    "github.com/tprasadtp/pkg/zerolog/log"
)
...
import (
	...
	"github.com/tprasadtp/pkg/zerolog/pkgerrors"
...
The `github.com/tprasadtp/pkg/zerolog/hlog` package provides some helpers to integrate zerolog with `http.Handler`.

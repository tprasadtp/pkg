...
// Reopens the underlying os.File when a SIGHUP(configurable)
// is received by the app. This is based on [nytimes/logrotate].
//
// [nytimes/logrotate]: https://github.com/nytimes/logrotate
package logrotate

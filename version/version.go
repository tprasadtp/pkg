...
// build information.
//   - For cli use github.com/tprasadtp/x/cli
//   - For HTTP Server use github.com/tprasadtp/x/hsrv
//   - For GRPC Server use github.com/tprasadtp/x/gsrv
//   - For HTTP/GRPC gateway use github.com/tprasadtp/x/gmux
//
